    ...
    <main className="flex min-h-screen items-center justify-center px-4 py-10 text-foreground">
      <section className="w-full max-w-4xl bg-card p-6 md:p-10">
        <header className="mb-6 pb-2">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Alege metoda de autentificare: GitHub OAuth sau email + parola.</p>
        </header>

        <div className="grid gap-5 md:grid-cols-[1fr_auto_1fr] md:items-stretch">
          <div className="space-y-4 bg-card/60 p-5">
            <p className="text-xs font-semibold tracking-widest text-muted-foreground">OAUTH</p>
            <h2 className="font-mono text-xl font-semibold">GitHub Access</h2>
            <p className="text-sm text-muted-foreground">Logare rapida cu contul tau GitHub.</p>
          ...
          <div className="space-y-4 bg-card/60 p-5">
            <p className="text-xs font-semibold tracking-widest text-muted-foreground">CLASSIC</p>
            ...
            <form className="space-y-4" onSubmit={onSubmit}>
              ...
              <Link href="/forgot-password" className="inline-block text-xs text-muted-foreground underline underline-offset-4 transition hover:text-foreground">
                Ai uitat parola?
              </Link>
            </form>
          </div>
