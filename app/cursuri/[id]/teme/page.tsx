...
import { StudentCourseAssignmentsPage } from "@/components/student/StudentCourseAssignmentsPage";

export default async function CourseHomeworkPage(props: { params: Promise<{ id: string }> }) {
    ...
    return (
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col px-4 py-10">
        <section className="rounded-lg border border-border bg-card p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Trebuie sa fii autentificat ca student pentru a vedea temele.</p>
  ...
  return <StudentCourseAssignmentsPage courseId={courseId} />;
}
